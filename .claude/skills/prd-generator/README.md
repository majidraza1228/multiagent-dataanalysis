...
1. Unzip this file
2. Move the `prd-generator` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `prd-generator` folder to `~/.claude/skills/`
...
→ [Full documentation](https://mysecond.ai/skills/prd-generator)
